...
FROM
    ...
    booking
WHERE
    booking.user_booking_id=user_booking.user_booking_id AND booking.taxiInfo_id=ownerTaxiInfo.taxiInfo_id AND  user_booking.status = 'OA' OR user_booking.status = 'OR'";
    ...
    ?>
                                    <tr>
                                        ...
                                        <td><?php $status = $row['status'];
                                                    if ($status == 'OA') { ?>
                                            <center>
                                                <p class="btn btn-success rounded">Approved</p>
                                            </center>
                                            <?php  } elseif ($status == 'OR') { ?>
                                            <center>
                                                <p class="bg-danger btn  rounded">Rejected</p>
                                            </center>
                                            <?php } else { ?>
                                            <center>
                                                <p class="bg-danger btn  rounded">Rejected</p>
